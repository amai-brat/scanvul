            ...
            <div className="space-y-4 overflow-y-auto pr-2 flex-1 custom-scrollbar">
              {organizedVulns.length === 0 ? (
                ...
                organizedVulns.map((pkg) => (
                  ...
                  >
                    {/* Package Header */}
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-3 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center cursor-pointer"
                         onClick={() => setExpandedPackageId(prev => prev === null ? pkg.packageId : null)}>
