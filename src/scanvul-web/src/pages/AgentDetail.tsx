...
export const AgentDetail = () => {
  ...
  if (!agent) return <div className="p-8 text-center">Loading agent info...</div>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-min">
        ...
        {/* Vulnerable Packages Block */}
        <Card
          title={`Security Findings (${vulnData?.packages.length ?? 0})`}
          className="md:col-span-2 lg:col-span-1 h-150 flex flex-col"
        >
          {vulnLoading ? (
            ...
            <div className="space-y-4 overflow-y-auto pr-2 flex-1 custom-scrollbar">
              {organizedVulns.length === 0 ? (
                ...
                organizedVulns.map((pkg) => (
                  ...
                  >
                    {/* Package Header */}
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-3 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
