...
namespace ScanVul.Server.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260124180251_AddBduVulnerablePackage")]
    partial class AddBduVulnerablePackage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScanVul.Server.Domain.AgentAggregate.Entities.BduVulnerablePackage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bdu_vulnerable_package");

                    b.HasIndex("ComputerId")
                        .HasDatabaseName("ix_bdu_vulnerable_package_computer_id");

                    b.HasIndex("PackageInfoId", "BduId", "ComputerId")
                        .IsUnique()
                        .HasDatabaseName("ix_bdu_vulnerable_package_package_info_id_bdu_id_computer_id");

                    b.ToTable("bdu_vulnerable_package", (string)null);
                });
            ...
            modelBuilder.Entity("ScanVul.Server.Domain.AgentAggregate.Entities.BduVulnerablePackage", b =>
                {
                    b.HasOne("ScanVul.Server.Domain.AgentAggregate.Entities.Computer", "Computer")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bdu_vulnerable_package_computers_computer_id");
                    ...
                    b.HasOne("ScanVul.Server.Domain.AgentAggregate.Entities.PackageInfo", "PackageInfo")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bdu_vulnerable_package_package_infos_package_info_id");
