...
public interface ISnapshotRepository
{
    ...
    Task<ScanSnapshot?> GetWithPayloadAsync(Guid snapshotId, CancellationToken ct = default);
    Task<ScanSnapshot?> GetWithDiffAsync(Guid snapshotId, CancellationToken ct = default);
}